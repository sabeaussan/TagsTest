...
class PublicMark {
  ...
  PublicMark.fromDocumentSnapshot(DocumentSnapshot snapshot):
    ...
    _photoOnly=snapshot.data["photoOnly"],
    _tagRange=snapshot.data["tagRange"],
    _lastPostTimeStamp=snapshot.data["lastPostTimeStamp"],
    _description=snapshot.data["description"],
    _popularity = snapshot.data["popularity"],
    _nbViews=snapshot.data["nbViews"];
